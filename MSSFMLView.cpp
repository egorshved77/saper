...
void MSSFMLView::draw(sf::RenderWindow &window) const {
    ...
    // Załaduj czcionkę
    sf::Font font;
    if (!font.loadFromFile("C:/Users/egors/programowanie obiektowe/saper1/saper_yahor_shved/arialmt.ttf")) {
        std::cerr << "Błąd ładowania czcionki Arial!" << std::endl;
        return;
    }

    sf::Texture t;
    t.loadFromFile("C:/Users/egors/programowanie obiektowe/saper1/saper_yahor_shved/images/tiles.jpg");
    sf::Sprite s(t);
